...
namespace pageGV
{
    ...
    public class pagedGridView : GridView, IPageableItemContainer
    {
        ...
        {
            add { base.Events.AddHandler(pagedGridView.EventTotalRowCountAvailable, value); }
            remove { base.Events.RemoveHandler(pagedGridView.EventTotalRowCountAvailable, value); }
        }
        ...
        {
            EventHandler<PageEventArgs> handler = (EventHandler<PageEventArgs>)base.Events[pagedGridView.EventTotalRowCountAvailable];
            if (handler != null)
            {
                handler(this, e);
            }
